...
public class UserListActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.share){
            ...
            Toast.makeText(this, "User "+username+" Logged out",Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<ParseUser> userIds = new ArrayList<>();
        ...
        parseQuery.findInBackground(new FindCallback<ParseUser>() {
            ...
            public void done(List<ParseUser> objects, ParseException e) {
                if(e == null && !objects.isEmpty()){
                    ...
                    Log.i("Failed", "Received no Users");
            }
        });
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bundle.putString("userId",userIds.get(position).getObjectId());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                //Upload image to parse server by converting bitmap to byte array
